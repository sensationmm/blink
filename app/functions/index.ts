...
admin.initializeApp({
    credential: admin.credential.cert({
        ...
        "client_email":  process.env.FIREBASE_SERVICE_ACCOUNT_CLIENT_EMAIL_ID || functions.config().service_account_client_email_id.key,
        "client_id":  process.env.FIREBASE_SERVICE_ACCOUNT_CLIENT_ID || functions.config().service_account_client_email.key,
