...
server.post('*/', async function (req: any, res: any) {
    ...
    if (successfullyCreatedUsers.length > 0) {
        ...
        await Promise.all(successfullyCreatedUsers.map((user: any) => {
            ...
            emailLink = `${BLINK_WEB_ADDRESS}?login=${credentials}`
            ...
            request.post({
                ...
                body: JSON.stringify({
                    ...
                    "body": `<html><body style="padding:0; margin:0;"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="background:url(https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/shadow-left.gif?alt=media&token=1793b7d2-a468-48d2-b3a1-bbf1e152709b) top right repeat-y"></td><td width="910px"><table width="100%" cellpadding="0" cellspacing="0"><tr><td><table width="100%" cellpadding="0" cellspacing="0"><tr><td><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-1a.gif?alt=media&token=bf099aef-7231-405d-ae60-acfaf6037192" /></td><td><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-1b.gif?alt=media&token=645b11b0-1a12-472b-9215-ee56b11426aa" /></td></tr><tr><td><a href="${BLINK_WEB_ADDRESS}?login=${credentials}"><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-2a.gif?alt=media&token=b862caa5-445a-49b1-ba2f-e86e572ab6d9" /></a></td><td><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-2b.gif?alt=media&token=a8943e60-f6b9-454e-9340-cf5ce70f6d2b" /></td></tr></table></td></tr><tr><td style="padding: 20px 30px; background: #f6feff;font-family: Avenir, Times; font-size: 1.6em;">${text}</td></tr><tr><td><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-3.gif?alt=media&token=a0e1a76d-6b5f-44b9-ab80-3f0abdba241a" /></td></tr><tr><td><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-4.gif?alt=media&token=91c4ac10-8009-4978-ba24-613d5f096718" /></td></tr><tr><td><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-5.gif?alt=media&token=15be753a-19aa-467c-96be-308dd2ab43e7" /></td></tr><tr><td style="background:#fff;text-align: center;padding-bottom: 30px;"><a href="${emailLink}"><img style="display:block;" src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-2a.gif?alt=media&token=b862caa5-445a-49b1-ba2f-e86e572ab6d9" /></a></td></tr></table></td><td style="background:url(https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/shadow-right.gif?alt=media&token=a9df2756-c1f1-4c8c-b069-07e26ea8d852) top left repeat-y"></td></tr></table></body></html>`
                })
            }, async function (error: any, response: any, body: any) {
                if (error) {
                    console.log("error", error);
        ...
        res.send({ success: true, emailLink });
    } else {
