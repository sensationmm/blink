        ...
        <MainStyled.MainSt>
            ...
            <MainStyled.ContentNarrow>
                <Email>
                    ...
                    </td></tr><tr><td><img style={{ display: 'block' }} src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-3.gif?alt=media&token=a0e1a76d-6b5f-44b9-ab80-3f0abdba241a" /></td></tr><tr><td><img style={{ display: 'block' }} src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-4.gif?alt=media&token=91c4ac10-8009-4978-ba24-613d5f096718" /></td></tr><tr><td><img style={{ display: 'block' }} src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-5.gif?alt=media&token=15be753a-19aa-467c-96be-308dd2ab43e7" /></td></tr><tr><td style={{ background: '#fff', textAlign: 'center', paddingBottom: '30px' }}><img style={{ display: 'block' }} src="https://firebasestorage.googleapis.com/v0/b/blink-staging-20006.appspot.com/o/email-2a.gif?alt=media&token=b862caa5-445a-49b1-ba2f-e86e572ab6d9" /></td></tr></table>
                </Email>
